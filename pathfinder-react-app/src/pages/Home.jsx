                ...
                <div className="container">
                    <div className="footer-content">
                        ...
                        <div className="footer-social">
                            <a href="https://www.instagram.com/empirasglobalacademy/?hl=en" target="_blank" rel="noopener noreferrer" className="social-icon">
                                <i className="fab fa-instagram"></i>
                            </a>
                            <a href="https://www.facebook.com/empirasglobalacademy" target="_blank" rel="noopener noreferrer" className="social-icon">
                                <i className="fab fa-facebook"></i>
                            </a>
                            <a href="https://x.com/empirasglobal/status/1962431564660531362" target="_blank" rel="noopener noreferrer" className="social-icon">
                                <i className="fab fa-twitter"></i>
                            </a>
                            <a href="https://www.linkedin.com/company/empiras/posts/?feedView=all" target="_blank" rel="noopener noreferrer" className="social-icon">
                                <i className="fab fa-linkedin"></i>
                            </a>
                        </div>
                        
                        <div className="footer-bottom">
                            <p>&copy; 2025 Pathfinder Global Academy. All rights reserved.</p>
                        </div>
                    </div>
                </div>
            </footer>
